...
define([
    ...
    function BIPComponentTypeDecoratorCore() {

    }

    BIPComponentTypeDecoratorCore.prototype._updateColors = function () {
    ...
    BIPComponentTypeDecoratorCore.prototype._getNodeColorsFromRegistry = function () {
    ...
    return BIPComponentTypeDecoratorCore;
});
